...
class Overworld:
    def __init__(self,start_level,max_level,surface,create_level):
        ...
        ## nullify input timer
        self.nullify_input_timer = pygame.time.get_ticks()
        self.nullify_input = False
        self.nullify_input_duration = 600

    def input_timer(self):
        if not self.nullify_input:
            current_time = pygame.time.get_ticks()
            if current_time - self.nullify_input_timer >= self.nullify_input_duration:
                self.nullify_input = True
    ...
    def input(self):
        ...
        if not self.moving and self.nullify_input:
